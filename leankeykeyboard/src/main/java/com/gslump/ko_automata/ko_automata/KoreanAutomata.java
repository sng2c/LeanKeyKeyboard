...
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.FIRST;
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.INIT;
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.LAST1;
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.LAST2;
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.MIDDLE1;
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.MIDDLE2;
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.SINGLE_MIDDLE1;
import static com.gslump.ko_automata.ko_automata.KoreanAutomata.ComposingFsm.ComposingStatePrefix.SINGLE_MIDDLE2;


public class KoreanAutomata {
    private final ComposingFsm fsm;
    public static final String BACKSPACE = String.valueOf((char) 0x08);

    public KoreanAutomata() {
        fsm = new ComposingFsm();
    }

    public Output type(ComposingContext context, String ch) {
        String commit = null;
        String compose = null;
        while (ch != null) {
    ...
    public Output typeBackspace(ComposingContext context) {
        String ci = null;
        String co = null;
